...
const Products = () => {
    return (
        <div className="flex flex-col justify-center items-center h-screen bg-gradient-to-b from-gray-900 to-black p-8 text-white">
            <motion.h2 
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 max-w-7xl w-full p-8">
                {productImages.map((img, index) => (
                    <motion.div 
                        key={index} 
                        className="bg-gray-800 rounded-2xl shadow-lg overflow-hidden flex items-center justify-center p-4 border border-gray-700"
